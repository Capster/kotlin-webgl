...
interface KotlinMath {
    fun toTypedArray(): Array<Float>
}
...
data class Float2(var x: Float = 0.0f, var y: Float = 0.0f) : KotlinMath {
    ...
    override fun toTypedArray() = arrayOf(
        x, y
    )
}

data class Float3(var x: Float = 0.0f, var y: Float = 0.0f, var z: Float = 0.0f): KotlinMath {
