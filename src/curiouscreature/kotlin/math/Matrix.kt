...
data class Mat2(
        ...
        var y: Float2 = Float2(y = 1.0f)) : KotlinMath {
...
data class Mat3(
        ...
        var z: Float3 = Float3(z = 1.0f)) : KotlinMath {
...
data class Mat4(
        ...
        var w: Float4 = Float4(w = 1.0f)) : KotlinMath {
...
fun rotation(quat: Quat): Mat4 {
    val x = quat.x
    val y = quat.y
    val z = quat.z

    val r = radians(quat.w)
    val c = cos(r)
    val s = sin(r)
    val d = 1.0f - c
